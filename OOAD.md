...
&emsp;&emsp;A class gets the state and behavior of another class and adds additional state and behaviour.
- **多态:Polymorphism**
-- 本意:有多种形态
...
-- eg:A University is a collection of students, faculty, and courses
...
**A variant of aggregation is compostion which adds the property of existence dependency**
-- 组合强调:整体控制生命
